...
permalink: /backend/frame/laravel/model/factory/
titleTag: 原创
categories: 
  - 后端
  - 框架
...
```php
'phone' =>$this->faker->regexify('/^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|17[0-9]|18[0-9])\d{8}$/');

'phone' => fake()->regexify('/^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|17[0-9]|18[0-9])\d{8}$/'),
```
